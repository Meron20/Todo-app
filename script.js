...
const url = 'https://js1-todo-api.vercel.app/api/todos?apikey=8a5c6207-19dc-4e76-8898-86b678df93fa';
...
const addPost = async () => {
   ...
   try{
      const res = await fetch('https://js1-todo-api.vercel.app/api/todos?apikey=8a5c6207-19dc-4e76-8898-86b678df93fa', {
...
const updatePost = async () => {
 ...
 try{
    ...
    const res = await fetch(`https://js1-todo-api.vercel.app/api/todos/${id}?apikey=8a5c6207-19dc-4e76-8898-86b678df93fa`, {
